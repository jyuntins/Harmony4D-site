...
class ExoCamera:
    ...
    def update(self, time_stamp):
        ...
        # print(self.raw_extrinsics)
        # print(self.raw_extrinsics.shape)
        # self.extrinsics = self.raw_extrinsics
        # self.raw_extrinsics[:, 3] = np.dot(self.coordinate_transform, self.raw_extrinsics[:, 3])
        self.extrinsics = np.dot(self.raw_extrinsics, self.coordinate_transform)
        # print(self.extrinsics)
        # print(self.extrinsics.shape)

        # input()

        # self.extrinsics = np.dot(self.coordinate_transform, self.raw_extrinsics)
    ...
    def get_bbox_2d(self, aria_human):
        ...
        if aspect_ratio > max_aspect_ratio_thres or aspect_ratio < min_aspect_ratio_thres:
            # print(aspect_ratio)
            # print(max_aspect_ratio_thres)
            # print(min_aspect_ratio_thres)
            # print("bbox too skewed")
            return None
