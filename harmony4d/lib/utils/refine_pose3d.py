...
def fill_missing_keypoints(cfg, poses, num_keypoints=17, human_name=None, debug=False):
    ...
    for i in range(num_keypoints):
        ...
        for missing_timestamp in missing_timestamps:
            ...
            # print(right_window_length)
            # print(total_time - 1)
            # print(right_timestamp)
            # input()
            ...
            # print(left_timestamp, right_timestamp, missing_timestamp)
            # print(valid_values)
            if valid_values <= 3:
...
def sliding_interpolate(x_df, y_df, z_df, polyorder=5):
    ...
    # print("x_prime_df", x_prime_df)
    # print("y_prime_df", y_prime_df)
    # print("z_prime_df", z_prime_df)
