...
def main():
    ...
    parser.add_argument('--render_aria', action='store_true', help='render aria humans')
    ...
    mesh_output_path = os.path.join(args.output_path, 'mesh_collision_cam') 
    vis_output_path = os.path.join(args.output_path, 'vis_smpl_collision_cam_blender') 
    ...
    ##-----------------smpl-----------------------
    scene.load_smpl_collision() ## load all the 3d poses in memory
    ...
    if end_time == -1:
        end_time = scene.total_time_smpl_collision 
    ...
    camera_names = ['cam01']
    camera_names=['cam01', 'cam02', 'cam03', 'cam04', 'cam05', 'cam06', 'cam07' ,'cam08', 'cam09', 'cam10', 'cam11', 'cam12', 'cam13', 'cam14', 'cam15', 'cam16' ,'cam17', 'cam18', 'cam19', 'cam20']
