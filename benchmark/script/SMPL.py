...
class SMPLModel:
    def __init__(self):
        ...
        self.smpl_model = smplx.create('/home/rawalk/Desktop/ego/cliff/data', "smpl").to(self.device)
    ...
    def get_vertices_and_joints(self, pred_betas, pred_rotmat, pred_cam_full):
        ...
        identity_global_orient = torch.Tensor(np.eye(3).reshape(1, 1, 3, 3)).to(self.device)
