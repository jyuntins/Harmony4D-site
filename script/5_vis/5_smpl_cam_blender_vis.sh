...
###----------------------------------------------------------------
RUN_FILE='tools/vis/smpl_cam_blender.py'
...
# SEQUENCE='005_ballroom'; 
# DEVICES=2,;
# RENDER_ARIA=false; NUM_EXO_CAMERAS=9

# # # # # ###-----------------------------------------------------------
# BIG_SEQUENCE='23_ballroom3'
# SEQUENCE='010_ballroom3';
# DEVICES=1,;
# RENDER_ARIA=false; NUM_EXO_CAMERAS=9
...
# SEQUENCE='006_karate3'; DEVICES=0,
# RENDER_ARIA=false; NUM_EXO_CAMERAS=9
...
# START_TIME=387; END_TIME=474; DEVICES=0,
